...
while program_counter < len(instructions):
    ...
    if opcode == "0110011":
        ...
        if funct3 == "000" and funct7 == "0000000":
            if rd != 0:
                registers_state_of_all[rd] = (registers_state_of_all[rs1] + registers_state_of_all[rs2]) & 0xFFFFFFFF
            ...
            signed_extend_1 = to_signed_32(value_in_rs1)
            signed_extend_2 = to_signed_32(value_in_rs2)
            if rd != 0:
                if signed_extend_1 < signed_extend_2:
        ...
        actual_immediate = instruction_jo_execute_krna_hai_1_1_krke[0] + instruction_jo_execute_krna_hai_1_1_krke[24] + instruction_jo_execute_krna_hai_1_1_krke[1:7] + instruction_jo_execute_krna_hai_1_1_krke[20:24] + "0"
        ...
        if funct3 == "000" and rs1 == 0 and rs2 == 0 and immediate_actually_used == 0:
            registers_state_of_all[0] = 0
            output_lines = save_register_state(program_counter, registers_state_of_all, output_lines)
        ...
        if funct3 == "000":
            ...
            signed_value_of_rs1 = to_signed_32(value_in_rs1)
            signed_value_of_rs2 = to_signed_32(value_in_rs2)
            if signed_value_of_rs1 < signed_value_of_rs2:
                branch_taken(immediate_actually_used)
                continue
        ...
        program_counter_used_in_J_of_next_instr = program_counter + 1

        if rd != 0:
            registers_state_of_all[rd] = (program_counter_used_in_J_of_next_instr * 4) & 0xFFFFFFFF
